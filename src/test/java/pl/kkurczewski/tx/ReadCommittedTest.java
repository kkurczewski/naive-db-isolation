...
class ReadCommittedTest {
    ...
    @Test
    void isolation_is_readCommitted_and_phantomRow_occurred_1() {
    ...
    @Test
    void isolation_is_readCommitted_and_phantomRow_occurred_2() {
        var table = Table.of(1, 2, 3);
    ...
    @Test
    void isolation_is_readCommitted_and_phantomRow_occurred_3() {
        var table = Table.of(1, 2, 3);
    ...
    @Test
    void isolation_is_readCommitted_and_row_move_occurred_1() {
        var table = Table.of(1, 2, 3);
